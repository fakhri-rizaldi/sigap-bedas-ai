...
# Daftar stopword Bahasa Indonesia esensial yang aman untuk klasifikasi teks aduan
INDONESIAN_STOPWORDS = {
    'ada', 'adalah', 'adanya', 'adapun', 'agak', 'agar', 'akan', 'akankah', 'akhir', 'akhiri',
    'akhirnya', 'aku', 'akulah', 'amat', 'amatlah', 'anda', 'andalah', 'antar', 'antara',
    ...
    'baik', 'bakal', 'bakalan', 'balik', 'banyak', 'bapak', 'beberapa', 'begini', 'beginian',
    'beginikah', 'beginilah', 'begitu', 'begitukah', 'begitulah', 'begitupun', 'bekerja',
    ...
    'berjumlah', 'berkala', 'berkali-kali', 'berkata', 'berkehendak', 'berkeinginan', 'berkenaan',
    ...
    'bila', 'bilakah', 'bisa', 'bisakah', 'boleh', 'bolehkah', 'bolehlah', 'buat', 'bukan',
    'bukankah', 'bukanlah', 'bukannya', 'cuma', 'dan', 'dapat', 'dari', 'daripada', 'dekat',
    ...
    'disampaikan', 'disebut', 'disebutkan', 'disebutkannya', 'disini', 'disinilah', 'disitu',
    'disitulah', 'ditambahkan', 'ditandaskan', 'ditanya', 'ditanyai', 'ditanyakan', 'ditegaskan',
    'diterima', 'ditujukan', 'ditunjuk', 'ditunjuki', 'ditunjukkan', 'ditunjukkannya', 'ditunjuknya',
    'dituturkan', 'dituturkannya', 'diucapkan', 'diucapkannya', 'diungkapkan', 'dong', 'dulu',
    'guna', 'gunakan', 'hal', 'hampir', 'hanya', 'hanyalah', 'harus', 'haruslah', 'harusnya',
    ...
    'janganlah', 'jauh', 'jelas', 'jelaskan', 'jelaslah', 'jelasnya', 'jika', 'jikalau', 'juga',
    ...
    'kedua', 'keduanya', 'keinginan', 'kelen', 'kelihatan', 'kelihatannya', 'kelima', 'keluar',
    ...
    'lihat', 'mah', 'maka', 'makanya', 'makin', 'malah', 'malahan', 'mampu', 'mampukah', 'mana',
    ...
    'memungkinkan', 'menaiki', 'menandaskan', 'menanti', 'menanti-nanti', 'menantikan', 'menanya',
    ...
    'menjadi', 'menjawab', 'menuju', 'menunjuk', 'menunjuki', 'menunjukkan', 'menunjuknya',
    ...
    'meyakini', 'meyakinkan', 'minta', 'mirip', 'misal', 'misalkan', 'misalnya', 'mohon', 'mula',
    'mulai', 'mulailah', 'mulanya', 'mungkin', 'mungkinkah', 'nah', 'naik', 'namun', 'nanti',
    'nantinya', 'nyaris', 'nyata', 'nyatanya', 'oleh', 'olehnya', 'pada', 'padahal', 'padanya',
    ...
    'pertama-tama', 'pertanyaan', 'pertanyakan', 'pihak', 'pihaknya', 'pula', 'pun', 'punya',
    ...
    'satu', 'saya', 'sayalah', 'se', 'sebab', 'sebabnya', 'sebagai', 'sebagaimana', 'sebagainya',
    ...
    'sekadar', 'sekadarnya', 'sekali', 'sekalian', 'sekaligus', 'sekalipun', 'sekarang',
    'sekaranglah', 'sekecil', 'seketika', 'sekiranya', 'sekitar', 'sekitarnya', 'sekurang-kurangnya',
    ...
    'siapapun', 'sini', 'sinilah', 'situ', 'situlah', 'suatu', 'sudah', 'sudahkah', 'sudahlah',
    'supaya', 'tadi', 'tadinya', 'tahu', 'tak', 'tambah', 'tambahnya', 'tampak', 'tampaknya',
    'tandas', 'tandasnya', 'tanpa', 'tanya', 'tanyakan', 'tanyanya', 'tapi', 'tegas', 'tegasnya',
    'telah', 'tempat', 'tentang', 'tentu', 'tentulah', 'tentunya', 'tepat', 'terakhir', 'terasa',
    ...
    'tidakkah', 'tidaklah', 'tiga', 'toh', 'tolong', 'turut', 'tutur', 'tuturnya', 'ucap', 'ucapnya',
    ...
    'yang', 'yg', 'dgn', 'krn', 'sy', 'bgt', 'udh', 'gak', 'ga', 'gk', 'min', 'pa', 'pak'
}

def clean_text(text: str) -> str:
    """Membersihkan teks dari URL, mention, karakter non-alfabet, dan spasi berlebih."""
    ...
    # Hapus mention @user atau hashtag #tag
    text = re.sub(r'[@#]\w+', ' ', text)
    
    # Ganti tanda baca dengan spasi
    text = re.sub(r'[' + re.escape(string.punctuation) + r'0-9]', ' ', text)
...
def preprocess(text: str) -> str:
    """Pipeline penuh preprocessing teks."""
